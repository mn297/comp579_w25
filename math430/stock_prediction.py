...
print(data.tail(3))
print("\nKey statistics:")
print(data[['Close', 'SMA_10', 'RSI', 'MACD']].describe())

# Visualize price and indicators
plt.figure(figsize=(12,6))
plt.title('Price and Moving Averages')
plt.plot(data.index, data['Close'], label='Price', alpha=0.5)
plt.plot(data.index, data['SMA_10'], label='10-day SMA', linewidth=2)
plt.plot(data.index, data['SMA_30'], label='30-day SMA', linewidth=2)
plt.legend()
plt.grid(True)
plt.show()
